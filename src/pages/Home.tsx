...
import {ShieldCheck, Star, ThumbsUp, Truck} from 'lucide-react';
            ...
            <section className="py-12 bg-blue-900 border-y border-white/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {[
                            {icon: <Truck className="text-orange-500"/>, label: "Rapid Response", sub: "Under 60 mins"},
                            {
            ...
            <section className="py-24 bg-gray-50 overflow-hidden relative" id="about">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            <span className="text-orange-500 font-bold uppercase tracking-widest text-sm mb-4 block">About Our Company</span>
                            ...
                            <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                                MA Berario Plumbers & Electricians is a locally owned and operated business committed to
                                providing the highest quality maintenance services. We understand that plumbing leaks or
                                power outages don't wait for business hours, which is why we remain operational 24/7.
                            </p>
